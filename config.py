...
task_once = {
    ...
    "55e9aaf31b36aada75e4aa84f28827a4": str(round(random.uniform(36.3, 36.8), 1)),
...
tasks = [
    ...
    # 午检
    {
        ...
        "9c30f111dd364f6cac3c77eb57d8b1cc": str(round(random.uniform(36.3, 36.8), 1)),
    ...
    # 晚检
    {
        ...
        "587168e43974c9f4e2657f40cc4f1090": str(round(random.uniform(36.1, 36.8), 1)),
